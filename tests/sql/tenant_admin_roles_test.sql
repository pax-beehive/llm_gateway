...
BEGIN
    IF NOT has_table_privilege('llm_gateway_tenant_admin_test', 'tenants', 'INSERT')
	   ...
	   OR NOT has_table_privilege('llm_gateway_tenant_admin_test', 'operations_metering_heartbeats', 'INSERT')
	   OR NOT has_table_privilege('llm_gateway_tenant_admin_test', 'operations_metering_heartbeats', 'UPDATE')
	   ...
	   OR NOT has_table_privilege('llm_gateway_tenant_admin_test', 'quota_reservations', 'SELECT')
	   OR has_table_privilege('llm_gateway_tenant_admin_test', 'quota_reservations', 'UPDATE')
	   OR NOT has_table_privilege('llm_gateway_tenant_admin_test', 'tenant_quota_counters', 'SELECT')
	   OR has_table_privilege('llm_gateway_tenant_admin_test', 'tenant_quota_counters', 'UPDATE')
